...
if (navigator.userAgent.indexOf('Mac OS X') !== -1) {
  document.getElementById('wrapper').className += ' mac';
} else {
  document.getElementById('wrapper').className += ' pc';
}
