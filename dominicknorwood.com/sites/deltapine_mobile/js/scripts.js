	...
	$('#yield-calculator').submit(function(event) {
			event.preventDefault();
				...
				if (!isNaN(farmValue)) {
					...
					$('#yield-calculator #calculate').attr("disabled", "disabled");
					$('#yield-calculator #calculate').parent().addClass('disabled');
	...
	function clearResults() {
		$(".calResults :input").each(function(){
			...
			if (type == 'text')
				...
				$('#yield-calculator #calculate').removeAttr("disabled", "disabled");
				$('#yield-calculator #calculate').parent().removeClass('disabled');
